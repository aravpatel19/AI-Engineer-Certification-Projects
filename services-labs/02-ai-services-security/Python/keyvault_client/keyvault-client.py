...
def main():
    ...
    try:
        ...
        # Create a credential object using the service principal credentials
        credential = ClientSecretCredential(app_tenant, app_id, app_password)
        # Create a key vault client using the url and credential
        keyvault_client = SecretClient(key_vault_uri, credential)
        # Create a secret key object using the keyvault client
